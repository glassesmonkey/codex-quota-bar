...
Codex Quota Bar reads the local Codex session from `~/.codex/auth.json` and shows quota usage in the macOS menu bar.
...
SwiftUI 版本需要完整 Xcode，不能只装 Command Line Tools。
